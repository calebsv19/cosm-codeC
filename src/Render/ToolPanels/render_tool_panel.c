...
#include "Render/ToolPanels/render_tool_panel.h"
...
#include "Render/ToolPanels/render_tool_libraries.h"
...
#include "Render/ToolPanels/render_tool_tasks.h"
#include "Render/ToolPanels/render_tool_git.h"
