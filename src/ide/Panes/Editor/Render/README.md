...
| `editor_diagnostic_markers.h/c` | Draws compiler diagnostics as active-file inline markers and scrollbar overview ticks from the flattened diagnostics engine. |
