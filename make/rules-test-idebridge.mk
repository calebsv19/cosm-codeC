.PHONY: test-idebridge-error-format
test-idebridge-error-format:
	@mkdir -p $(TEST_BUILD_DIR)
	@echo "Compiling idebridge error formatter test..."
	@$(CC) $(CFLAGS) tests/idebridge_error_format_test.c tools/idebridge/idebridge_error_format.c -o $(TEST_BUILD_DIR)/idebridge_error_format_test $(LIB_DIRS) -ljson-c || (echo "idebridge error formatter compile failed."; exit 1)
	@echo "Running idebridge error formatter test..."
	@$(TEST_BUILD_DIR)/idebridge_error_format_test || (echo "idebridge error formatter test failed."; exit 1)
	@echo "idebridge error formatter test passed."

.PHONY: test-idebridge-phase1
test-idebridge-phase1: $(IDEBRIDGE_OUT)
	@mkdir -p $(TEST_BUILD_DIR)
	@echo "Compiling idebridge phase-1 runtime check..."
	@$(CC) $(CFLAGS) tests/idebridge_phase1_check.c $(IDEBRIDGE_PHASE_TEST_SUPPORT_SRCS) -o $(IDEBRIDGE_PHASE1_TEST_OUT) $(LIB_DIRS) -ljson-c -lSDL2 || (echo "idebridge phase-1 compile failed."; exit 1)
...
test-idebridge-phase2:
	...
	@$(CC) $(CFLAGS) tests/idebridge_phase2_check.c $(IDEBRIDGE_PHASE_TEST_SUPPORT_SRCS) -o $(IDEBRIDGE_PHASE2_TEST_OUT) $(LIB_DIRS) -ljson-c -lSDL2 || (echo "idebridge phase-2 compile failed."; exit 1)
...
test-idebridge-phase3:
	...
	@$(CC) $(CFLAGS) tests/idebridge_phase3_check.c $(IDEBRIDGE_PHASE_TEST_SUPPORT_SRCS) -o $(IDEBRIDGE_PHASE3_TEST_OUT) $(LIB_DIRS) -ljson-c -lSDL2 || (echo "idebridge phase-3 compile failed."; exit 1)
...
test-idebridge-phase4:
	...
	@$(CC) $(CFLAGS) tests/idebridge_phase4_check.c $(IDEBRIDGE_PHASE_TEST_SUPPORT_SRCS) -o $(IDEBRIDGE_PHASE4_TEST_OUT) $(LIB_DIRS) -ljson-c -lSDL2 || (echo "idebridge phase-4 compile failed."; exit 1)
...
test-idebridge-phase5: $(IDEBRIDGE_OUT)
	...
	@$(CC) $(CFLAGS) tests/idebridge_phase5_check.c $(IDEBRIDGE_PHASE_TEST_SUPPORT_SRCS) -o $(IDEBRIDGE_PHASE5_TEST_OUT) $(LIB_DIRS) -ljson-c -lSDL2 || (echo "idebridge phase-5 compile failed."; exit 1)
...
test-idebridge-phase6: $(IDEBRIDGE_OUT)
	...
	@$(CC) $(CFLAGS) tests/idebridge_phase6_check.c $(IDEBRIDGE_PHASE_TEST_SUPPORT_SRCS) -o $(IDEBRIDGE_PHASE6_TEST_OUT) $(LIB_DIRS) -ljson-c -lSDL2 || (echo "idebridge phase-6 compile failed."; exit 1)
