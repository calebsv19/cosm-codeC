...
CORE_VIEWPORT2D_LIB_SRC := $(CORE_VIEWPORT2D_DIR)/build/libcore_viewport2d.a
...
IDE_SHARED_LIBS := $(KIT_WORKSPACE_AUTHORING_LIB) $(KIT_GRAPH_STRUCT_LIB) $(KIT_UI_LIB) $(KIT_RENDER_LIB) $(VK_RENDERER_LIB) $(VK_RUNTIME_LIB) $(CORE_WORKSPACE_AUTHORING_SESSION_LIB) $(CORE_KERNEL_LIB) $(CORE_WAKE_LIB) $(CORE_WORKERS_LIB) $(CORE_JOBS_LIB) $(CORE_SCHED_LIB) $(CORE_QUEUE_LIB) $(CORE_TIME_LIB) $(CORE_PACK_LIB) $(CORE_PANE_SNAPSHOT_LIB) $(CORE_PANE_MODULE_LIB) $(CORE_PANE_LIB) $(CORE_VIEWPORT2D_LIB) $(CORE_IO_LIB) $(CORE_DATA_LIB) $(CORE_THEME_LIB) $(CORE_FONT_LIB) $(CORE_BASE_LIB)
